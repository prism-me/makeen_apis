...
Route::delete('delete-queries/{id}' , 'ContactQueryController@delete');
Route::delete('delete-agent/{id}' , 'ContactQueryController@deleteAgent');
...
Route::delete('delete-query/{id}', 'QueryController@destroy');
