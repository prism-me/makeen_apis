...
class BunnyAPI
{
    private const API_KEY = '8d65c840-85ea-41c4-96d1-c02608669878955661da-7fba-44b9-93ee-cbd9227d09af';//BunnyCDN API key
    ...
    private string $storage_name ='american-gulf-school';
    private $connection;
    private string $data;
