...
class AuthController extends Controller
{
    ...
    public function __construct() {
        $this->middleware('auth:api', ['except' => ['login', 'register','all_users']]);
    }
    ...
    public function register(Request $request) {
        ...
        if($check > 0 && $request->is_social){
            ...
            $insert_2 = ['name'=>$request->name ,'email' =>$request->email ,'password'=>$request->password];
             $user = User::create($insert_2);
